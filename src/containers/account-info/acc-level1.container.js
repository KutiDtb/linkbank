...
class AccountLevel1Container extends PureComponent {
    constructor(props) {
        super(props);
    }
        ...
        return (
            ...
            >
                <View style={{
                    ...
                    <Text style={AppStyle.Paragraph_Center_Black}>{'Đặc quyền của Tư vấn viên'}</Text>
                </View>
            </BaseContainer>
        )
    }
...
export default connect(mapStateToProps, mapDispatchToProps)(AccountLevel1Container)